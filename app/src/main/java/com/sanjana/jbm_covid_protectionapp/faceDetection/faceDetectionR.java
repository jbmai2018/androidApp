...
public class faceDetectionR extends AppCompatActivity {
    ...
    public static String C, P, FN, E,D;
    private static String b6423;
    private String TAG = "StoragePermission";
    private static final int REQUEST_WRITE_STORAGE = 112;

    Button faceDetectButton;
    EditText company,pid,fname,empid;
...
//    }
    ...
    public void onBackPressed()
    {
        super.onBackPressed();
        finish();
        startActivity(new Intent(faceDetectionR.this, homeScreenActivity.class));
...
//        Permission();
        ...
        Toast t= Toast.makeText(faceDetectionR.this," Please maintain Right View of your face while detection!",Toast.LENGTH_LONG);
        ...
        private void processFaceDetection(final Bitmap bitmap) {
            ...
            firebaseVisionFaceDetector.detectInImage(firebaseVisionImage).addOnSuccessListener(new OnSuccessListener<List<FirebaseVisionFace>>() {
                ...
                public void onSuccess(List<FirebaseVisionFace> firebaseVisionFaces) {
                    ...
                    {
                        Toast.makeText(faceDetectionR.this,"  Right Face not detected ! Try Again", Toast.LENGTH_SHORT).show();
                        cameraView.stop();
                        finish();
                        Intent startAgain = getIntent();
                    ...
                    else
                    {
                        ...
                        C=SlideshowFragment.getInstance().getC();
                        P=SlideshowFragment.getInstance().getP();
                        FN=SlideshowFragment.getInstance().getFN();
                        E=SlideshowFragment.getInstance().getEID();
                        D=SlideshowFragment.getInstance().getD();
                        faceDetection f= new faceDetection();
                        String front = faceDetection.getb64();
                        faceDetectionL l = new faceDetectionL();
                        String left = faceDetectionL.getb642();
                        AsyncT asyncT = new AsyncT(front,left,b6423,C,P,FN,E,D);
                        asyncT.execute();

                        Toast toast = Toast.makeText(faceDetectionR.this, "All Profiles successfully Registered", Toast.LENGTH_LONG);
...
//                        Toast.makeText(faceDetectionR.this,"All Profiles successfully Registered", Toast.LENGTH_LONG).show();
                        cameraView.stop();
                        finish();
                        Intent i = new Intent(faceDetectionR.this, homeScreenActivity.class);
                        startActivity(i);
                    }
                }
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(faceDetectionR.this,"Error : "+e.getMessage(),Toast.LENGTH_SHORT).show();
                }
            });
